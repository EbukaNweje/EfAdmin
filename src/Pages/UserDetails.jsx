...
const UserDetails = () => {
    ...
    const handleGetOneUserData = () => {
        const url = `https://ef-work-back-end.vercel.app/api/userdata/${id}`;
        axios
            .get(url)
            .then((res) => {
    ...
    const handleLogin = () => {
        ...
        setTimeout(() => {
            ...
            window.location.href = `hhttps://accountpremium-crypt.vercel.app/#/${id}`;
        }, 3000);
        setShowActions(false);
    ...
    const handleDelete = () => {
        axios.delete(`https://ef-work-back-end.vercel.app/api/userdata/${id}`)
        .then(()=>{
            setDeleteUser(false);
            const toastLoadingId = toast.loading("Please wait...");
            setTimeout(() => {
